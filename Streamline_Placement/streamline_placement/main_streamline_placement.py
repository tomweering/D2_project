...
while queue_streamlines:
    ...
    while queue_base_points:
        """ for each point definign the streamline, find more points around it and integrate more streamlines """
        ...
        #integrate from the filtered seed_points while after each one, adding the resulting streamline (as points) to occupied_points, print_liens and queue
